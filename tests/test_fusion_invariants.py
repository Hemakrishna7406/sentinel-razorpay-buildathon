...
def test_fusion_invariant_1_both_low():
    ...
    semantic = SemanticRiskResult(
        risk_score=0.05, confidence=0.9, reason_codes=[], provider="sim", model_version="sim", latency_ms=10
    )
...
def test_fusion_invariant_3_behavioral_low_semantic_high():
    ...
    behavioral = BehavioralRiskResult(risk_score=0.05, confidence=0.9, reason_codes=[], model_version="v1")
    semantic = SemanticRiskResult(
        risk_score=0.75, confidence=0.9, reason_codes=[], provider="sim", model_version="sim", latency_ms=10
    )
...
def test_fusion_invariant_5_behavioral_low_semantic_critical():
    ...
    behavioral = BehavioralRiskResult(risk_score=0.05, confidence=0.9, reason_codes=[], model_version="v1")
    semantic = SemanticRiskResult(
        risk_score=0.95, confidence=0.9, reason_codes=[], provider="sim", model_version="sim", latency_ms=10
    )
...
def test_fusion_invariant_6_both_critical():
    ...
    behavioral = BehavioralRiskResult(risk_score=0.95, confidence=0.9, reason_codes=[], model_version="v1")
    semantic = SemanticRiskResult(
        risk_score=0.90, confidence=0.9, reason_codes=[], provider="sim", model_version="sim", latency_ms=10
    )
