...
def test_evasion_resistance():
    ...
    print_result("Evasion Resistance (Fusion Max Enforced)", passed, f"Decision: {decision.value}, Final Risk: {fusion_result.final_risk}, Reason: {reason}")
...
def test_absolute_bounds():
    ...
    semantic = SemanticRiskResult(risk_score=0.01, confidence=0.9, reason_codes=[], provider="sim", model_version="sim", latency_ms=10)
